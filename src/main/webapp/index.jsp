...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="calcular" name="calcular" class="btn btn-primary" onclick="CalculaIMC();">Calcular</button>
    <button id="calcular" name="ajuda" class="btn btn-primary" onclick="Duvida();">Ajuda</button>
  </div>
</div>
